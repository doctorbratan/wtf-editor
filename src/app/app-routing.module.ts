...
import { SubCategoryEditComponent } from './sub-category-page/sub-category-edit/sub-category-edit.component';
...
const routes: Routes = [
  ...
  [
    ...
    {path: 'sub-categories',  component: SubCategoryPageComponent},
    {path: 'sub-category',  component: SubCategoryEditComponent},
